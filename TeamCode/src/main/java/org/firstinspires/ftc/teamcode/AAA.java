...
// hello
@Autonomous(name = "AAA", group = "Autonomous")
@Configurable // Panels
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            line1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.000, 8.000), new Pose(56.221, 35.336))
                    )
            ...
            line2 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.221, 35.336), new Pose(18.827, 35.661))
                    )
            ...
            line3 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(18.827, 35.661), new Pose(56.210, 35.299))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            line4 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(56.210, 35.299), new Pose(55.811, 106.852))
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            line5 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(55.811, 106.852), new Pose(39.355, 111.011))
                    )
